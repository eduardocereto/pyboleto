...
class TestBancoSantander(BoletoTestCase):
    ...
    def test_agencia(self):
        self.assertEqual(self.dados.agencia_cedente, '1333')

    def test_nosso_numero(self):
        self.assertEqual(self.dados.nosso_numero, '000001234567')
        self.assertEqual(self.dados.format_nosso_numero(), '000001234567-9')
